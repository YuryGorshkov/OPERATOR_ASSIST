...
The main workflow uses local Vosk and Whisper modes rather than depending on cloud transcription APIs. That lowers operational friction and makes the tool usable even without online AI services.
...
As of September 23, 2026, the project already includes public releases, startup readiness improvements, selectable Vosk and Whisper modes, recognition benchmarking tools, packaging cleanup, and repository hardening, while still leaving room for production-grade audio regression testing and distribution polish.
